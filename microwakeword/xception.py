...
"""Xception - reduced version of keras/applications/inception_v3.py using depthwise and pointwise convolutions."""
import ast
...
def ds_conv_2d_bn_delay(
    ...
    """Utility function to apply depthwise conv + pointwise conv + BN.
...
def model_parameters(parser_nn):
    ...
    parser_nn.add_argument(
        ...
        type=str,
        default="10,10,16",
        help="Number of filters inside of xception block "
    ...
    parser_nn.add_argument(
        ...
        type=str,
        default="5,5,5",
        help="Kernel sizes of conv layers in the xception block",
    )
    parser_nn.add_argument(
...
def model(flags, shape, batch_size):
    ...
    Convolutions are placed with depthwise convolutions followed by pointwise convolutions
